...
function bg1() {
	body.style.backgroundImage = 'url(https://avatars.mds.yandex.net/get-mpic/4353087/img_id1567071194246313391.jpeg/orig)'
	body.style.backgroundSize = 'cover'
	body.style.backgroundRepeat = 'no-repeat'
	h1.style.color = 'white'
}
function bg2() {
	body.style.backgroundImage = 'url(https://dizajnerskieoboi.ru/upload/iblock/c71/c71ffa8f7d88e3659bb5e6a3a84f1d67.jpg)'
	body.style.backgroundSize = 'cover'
	body.style.backgroundRepeat = 'no-repeat'
	
}
function bg3() {
	body.style.backgroundImage = 'url(https://avatars.mds.yandex.net/get-mpic/4375199/img_id5539521903761610218.jpeg/orig)'
	body.style.backgroundSize = 'cover'
	body.style.backgroundRepeat = 'no-repeat'
}
function bg4() {
	body.style.backgroundImage = 'url(https://avatars.mds.yandex.net/get-mpic/5274753/img_id9017750839553861924.jpeg/orig)'
	body.style.backgroundSize = 'cover'
	body.style.backgroundRepeat = 'no-repeat'
}